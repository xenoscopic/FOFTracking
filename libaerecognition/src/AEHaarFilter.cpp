...
AEHaarFilter::AEHaarFilter(string cascadePath) throw(invalid_argument)
{
...
void AEHaarFilter::processImage(IplImage *origImg, IplImage *newImg, AEImageProcessingPipeline *pipeline)
{
